    ...
    WindowListener disposeListener = new WindowAdapter() {
        ...
        public void windowClosed(WindowEvent e) {
            ...
            if (codigo != 0) {
                ...
                carteirinhaRegistro.getDataCriacao().setText(Utilities.dateToString(carteirinha.getDatageracao()));
                carteirinhaRegistro.getDataCancelamento().setText(Utilities.dateToString(carteirinha.getDatacancelamento()));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == this.carteirinhaRegistro.getNovo()) {
            ...
            if (Utilities.isDataEmpty(this.carteirinhaRegistro.getMatricula(), this.carteirinhaRegistro.getIdCliente()) || Utilities.isFormattedDataEmpty(this.carteirinhaRegistro.getDataCancelamento(), this.carteirinhaRegistro.getDataCriacao())) {
                ...
                carteirinha.setDatageracao(Utilities.stringToDate(this.carteirinhaRegistro.getDataCriacao().getText()));
                carteirinha.setDatacancelamento(Utilities.stringToDate(this.carteirinhaRegistro.getDataCancelamento().getText()));
